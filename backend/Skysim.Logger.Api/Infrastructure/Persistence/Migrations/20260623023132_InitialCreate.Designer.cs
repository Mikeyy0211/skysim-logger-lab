...
namespace Skysim.Logger.Api.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260623023132_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Skysim.Logger.Api.Domain.Entities.LogAction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Skysim.Logger.Api.Domain.Entities.LogActionDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("log_action_details");
                });

            modelBuilder.Entity("Skysim.Logger.Api.Domain.Entities.LogFlow", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Skysim.Logger.Api.Domain.Entities.LogAction", b =>
                {
                    b.HasOne("Skysim.Logger.Api.Domain.Entities.LogFlow", "Flow")
                        .WithMany("Actions")
            ...
            modelBuilder.Entity("Skysim.Logger.Api.Domain.Entities.LogActionDetail", b =>
                {
                    b.HasOne("Skysim.Logger.Api.Domain.Entities.LogAction", "Action")
                        .WithOne("Detail")
                        .HasForeignKey("Skysim.Logger.Api.Domain.Entities.LogActionDetail", "ActionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
